...
def passenger_dashboard():
    ...
    # Sample dummy data – to be replaced with real aggregation logic later
    from collections import namedtuple
    Summary = namedtuple('Summary', ['total_trips', 'total_fare', 'avg_fare', 'top_route'])
    summary = Summary(total_trips=42, total_fare=21000, avg_fare=500, top_route="Route 56")

    table_rows = [
        {'date': '2025-07-14', 'trips': 5, 'fare': 2500, 'commission': 250},
        {'date': '2025-07-15', 'trips': 8, 'fare': 4000, 'commission': 400},
        {'date': '2025-07-16', 'trips': 6, 'fare': 3000, 'commission': 300},
    ]

    weekly_data = [
        {'week': 'Week 1', 'trips': 15},
        {'week': 'Week 2', 'trips': 20},
        {'week': 'Week 3', 'trips': 7},
    ]
