...
def assign_drivers_to_routes(drivers, vehicles, routes):
...
def main():
    ...
    try:
        # Run everything within a single app context
        with app.app_context():
            ...
            assignments = assign_drivers_to_routes(drivers, vehicles, routes)
