...
def passenger_dashboard():
    if current_user.role != 'passenger':
        flash("Unauthorized access", "error")
        return redirect("/")
    return render_template("dashboard_passenger.html")
...
def view_assigned_routes():
    ...
    return render_template('assigned_routes.html', assigned_routes=assignments)
import csv
...
def performance_tracker():
    ...
    table_rows = [
        {"date": "2024-04-10", "trips": 6, "fare": 18000, "commission": 1800},
        {"date": "2024-04-11", "trips": 7, "fare": 21000, "commission": 2100},
        {"date": "2024-04-12", "trips": 5, "fare": 15000, "commission": 1500}
    ]

    return render_template('templates/performance_tracker.html',
                           summary=summary,
